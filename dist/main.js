...
electron_1.ipcMain.handle('clean-repository', (event, options) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (textReplacements && textReplacements.length > 0) {
            ...
            const replacementsFile = path.join(electron_1.app.getPath('temp'), 'bfg-replacements.txt');
...
electron_1.ipcMain.handle('select-repository', () => __awaiter(void 0, void 0, void 0, function* () {
    if (!mainWindow)
...
electron_1.ipcMain.handle('select-bfg-jar', () => __awaiter(void 0, void 0, void 0, function* () {
    if (!mainWindow)
        return { canceled: true };
    const result = yield electron_1.dialog.showOpenDialog(mainWindow, {
        properties: ['openFile'],
